...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 11-03-2020 a las 13:24:53
...
(1, 'Nicolas', 'nico@correo.cl', 'Unas vacaciones Geniales'),
(2, 'Marcela', 'marcela@correo.com', 'will uncover many web sites still in their infancy. Various versions have evolved over the years, sometimes by accident, sometimes on purpose'),
(3, 'Ale', 'ale@correo.com', 'will uncover many web sites still in their infancy. Various versions have evolved over the years, sometimes by accident, sometimes on purpose'),
(4, 'Nuevo cliente', 'correo.@correo.com', 'Probando async await');
